...
export default function TasksTodayList() {
  return (
    <div className="flex flex-col gap-2 h-80 mt-24">
      <div className="flex flex-col items-center justify-between shadow-tg w-84 h-20 bg-primary rounded-lg p-2">
        <div className="flex w-full justify-between items-center h-6 ">
          ...
          <div className="pl-8 text-secondary font-semibold text-sm">00 : 30 : 00</div>
        ...
        <div className="flex w-full items-center justify-center p-1">
          <p className='font-semibold text-sm'>description of task</p>
        </div>
      </div>
    </div>
  );
